# -*- coding: utf-8 -*-
"""pggan_huy_keras.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1pZSAZz8kwro8m_aLFZHVrLk_2Fch1omW
"""
...
class Minibatchstev(Layer):
  ...
  def call(self, inputs):
    ...
    squared_diff = backend.square(input - mean) #TODO: input parameter? - mean?
...
def train(g_models,d_models,gan_models,dataset,lantent_dim, e_norm, e_fadein, n_batch):
  ...
  for i in range(1,len(g_models)):
    print("Number of G model: %s".format(i))
...
# Hyperparameters
img_path = '/content/drive/My Drive/Colab Notebooks/PG_GAN_MRI/data/yes'
n_blocks = 6
latent_dim = 100
