...
#Training steps
#Adding tf function decorator in training functions can speed up training
#but it cannot work with auto growing network. 
#Which means you have to re-run the notebook
#adjust the hyper parameters and set new current epoch to start with the higher resolution.
